...
class MultiPartParser(_MultiPartParser):
    """
    An extension of Django's built-in MultiPartParser to allows for custom
    parsing capabilities.

    The logic implemented here will be integrated into
    django.http.multipartparser.MultiPartParser when included into Django core.
    """

    def __init__(self, META, input_data, upload_handlers, encoding=None, parsers=None):
        super().__init__(META, input_data, upload_handlers, encoding)
        ...
        try:
            for item_type, meta_data, field_stream in Parser(stream, self._boundary):
                ...
                if item_type == FIELD:
                    ...
                    # Note: This is the custom logic that is really added.
                    # Everything else is standard Django behavior.
                    try:
                    ...
                    # Note: This completes the new behaviors
                elif item_type == FILE:
